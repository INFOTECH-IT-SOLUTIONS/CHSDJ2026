        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="d-flex py-3 my-3 my-lg-0 justify-content-center">
                    ...
                    <div>
                        <h3 class="mb-0">{!!
                            App\Helper::formatNumbersStats(App\Models\Campaigns::where('status','active')->count()) !!}
                        </h3>
            ...
            <div class="col-md-4">
                <div class="d-flex py-3 my-3 my-lg-0 justify-content-center">
                    ...
                    <div>
                        <h3 class="mb-0">@if($settings->currency_position == 'left') {{ $settings->currency_symbol
                            }}@endif{!!
                            App\Helper::formatNumbersStats(App\Models\Donations::where('approved','1')->sum('donation'))
                            !!}@if($settings->currency_position == 'right'){{ $settings->currency_symbol }} @endif</h3>
