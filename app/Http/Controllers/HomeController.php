...
class HomeController extends Controller
{
    ...
    {
        $video = DB::table('video_gallery')
            ->where('status', 1)
            ->get();
        return view('default.gallery-video',compact('video'));
    }
    ...
    public function committee_member()
    {
        $data = DB::table('committee_member')
            ->where('status', 1)
            ->get();
        return view('default.committee-member',compact('data'));
    }
    ...
    public function notice_board()
    {
        $data = DB::table('notice_board')
            ->where('status', 1)
            ->get();
        return view('default.notice-board',compact('data'));
    }
