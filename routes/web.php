...
Route::get('/perticipant/register', 'Auth\PerticipantRegister@showRegistrationForm');
Route::post('/perticipation/register', 'Auth\PerticipantRegister@register');
Route::post('/registration-success', 'Auth\PerticipantRegister@success');